...
class LvStyle {
  ...
  public:
    ...
    virtual ~LvStyle();
    lv_style_t * raw();
    lv_style_res_t getPropInlined(lv_style_prop_t prop, lv_style_value_t * value) const noexcept;
    ...
    lv_style_res_t getProp(lv_style_prop_t prop, lv_style_value_t * value) const noexcept;
    bool isEmpty();
    ...
    LvStyle & setAnimSpeed(const lv_anim_t value);
