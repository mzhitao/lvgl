...
lv_style_res_t LvStyle::getPropInlined(lv_style_prop_t prop, lv_style_value_t * value) const noexcept
{
...
lv_style_res_t LvStyle::getProp(lv_style_prop_t prop, lv_style_value_t * value) const noexcept
{
...
// LvStyle & LvStyle::setAnimSpeed(lv_anim_t value)
// {
//     lv_style_set_anim(cObj.get(), value);
//     return *this;
// }
...
{
    lv_style_set_bg_image_opa(cObj.get(), value);
    return *this;
}
...
{
    lv_style_set_bg_image_tiled(cObj.get(), value);
    return *this;
}
...
{
    lv_style_set_arc_image_src(cObj.get(), value);
    return *this;
}
