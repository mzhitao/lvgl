...
class LvBtnmatrix : public LvObj {
  public:
    ...
    LvBtnmatrix & setBtnCtrl(uint16_t btn_id, lv_buttonmatrix_ctrl_t ctrl);
    LvBtnmatrix & clearBtnCtrl(uint16_t btn_id, lv_buttonmatrix_ctrl_t ctrl);
    ...
    const char * const * getMap() const noexcept;
    uint16_t getSelectedBtn() const noexcept;
    const char * getBtnText(uint16_t btn_id) const noexcept;
    bool hasBtnCtrl(uint16_t btn_id, lv_buttonmatrix_ctrl_t ctrl);
