...
LvBtnmatrix & LvBtnmatrix::setBtnCtrl(uint16_t btn_id, lv_buttonmatrix_ctrl_t ctrl)
{
    lv_btnmatrix_set_btn_ctrl(cObj.get(), btn_id, ctrl);
    return *this;
}
LvBtnmatrix & LvBtnmatrix::clearBtnCtrl(uint16_t btn_id, lv_buttonmatrix_ctrl_t ctrl)
{
...
const char * const * LvBtnmatrix::getMap() const noexcept
{
...
bool LvBtnmatrix::hasBtnCtrl(uint16_t btn_id, lv_buttonmatrix_ctrl_t ctrl)
{
    return lv_buttonmatrix_has_button_ctrl(cObj.get(), btn_id, ctrl);
}
